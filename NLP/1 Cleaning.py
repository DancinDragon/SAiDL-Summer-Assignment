...
##AFTER RUNNING IT TWICE PLEASE OPEN BOTH THE .txt FILES AND REMOVE THE NEW LINE AT THE END OF THE DOCUMENT.
##THESE ARE THE ONLY THINGS YOU HAVE TO DO MANUALLY, ONLY RUNNING THE REST OF THE SCRIPTS WILL WORK :)
import re
import numpy as np
